...
public:
    ...
    bool isLastSendSuccessful() const { return lastSendSuccessful; }
...
private:
    ...
    bool lastSendSuccessful = false; // Tracks success of last send attempt
    ...
    bool checkResponse(QSslSocket &socket, const QString &expectedCode);
};
