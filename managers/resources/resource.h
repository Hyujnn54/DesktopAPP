...
public:
    ...
    bool addResource(const QString& employeeName = "Unknown");
    QSqlQueryModel* afficher();
    bool delet(int resource_id, const QString& employeeName = "Unknown");
    bool updateResource(const QString& employeeName = "Unknown");
