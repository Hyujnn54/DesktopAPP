...
"}"));
        ...
        dateEdit = new QDateTimeEdit(ClientForm);
        dateEdit->setObjectName("dateEdit");
        dateEdit->setMinimumSize(QSize(125, 0));
        ...
        gridLayout_2->addWidget(participant, 2, 1, 1, 1);
        ...
        gridLayout_2->addWidget(duration, 5, 1, 1, 1);
        ...
        gridLayout_2->addWidget(organiser, 1, 1, 1, 1);
        ...
        gridLayout_2->addWidget(AddButton, 6, 1, 1, 1);
        ...
        gridLayout_2->addWidget(agenda, 3, 1, 1, 1);
        ...
        aa = new QPushButton(listClient);
        aa->setObjectName("aa");

        horizontalLayout_4->addWidget(aa);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        aa->setText(QCoreApplication::translate("MainWindow", "PushButton", nullptr));
