...
public:
    ...
    void setupUi(QDialog *UpdateMeetingDialog)
    {
        ...
        label = new QLabel(UpdateMeetingDialog);
        label->setObjectName("label");

        formLayout->setWidget(6, QFormLayout::LabelRole, label);

        dateTimeEdit = new QDateTimeEdit(UpdateMeetingDialog);
    ...
    void retranslateUi(QDialog *UpdateMeetingDialog)
    {
        ...
        label->setText(QCoreApplication::translate("UpdateMeetingDialog", "date", nullptr));
